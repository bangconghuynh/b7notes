...
\section{Preliminaries}
	...
	\subsection{Vector Space}
		...
		In many vector spaces we encounter, it is often necessary to define an additional structure called \emph{inner product} so that the concept of distances and angles can be formalised.
